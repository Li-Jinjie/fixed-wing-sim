...
from tools.rotations import quaternion_2_euler, quaternion_2_rotation
...
class MavDynamics:
    ...
    def update(self, forces_moments):
        ...
        # Integrate ODE using Runge-Kutta RK4 algorithm. The knowledge in numerical integration.
